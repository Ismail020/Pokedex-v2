        ...
        <div className="p-5">
            ...
            {open && (
                <div className="fixed left-0 top-0 z-50 h-screen w-screen bg-background/80 p-[1.4rem] backdrop-blur md:p-[10vh] lg:p-[12vh]">
                    <div className="relative mx-auto flex h-fit max-h-full w-full max-w-[47.375rem] flex-col items-center overflow-y-auto overscroll-contain rounded bg-foreground shadow-custom">
